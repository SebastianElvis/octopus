 ...
 */
const KNOWN_COMMAND_INFO: Record<string, { description: string; category: SlashCommand["category"] }> = {
  // Session management
  "/clear": { description: "Clear conversation history and free up context", category: "session" },
  "/compact": { description: "Clear conversation history but keep a summary in context", category: "session" },
  ...
  "/export": { description: "Export the current conversation to a file or clipboard", category: "session" },
  ...
  "/btw": { description: "Ask a quick side question without interrupting the main conversation", category: "session" },
  ...
  "/keybindings": { description: "Open or create your keybindings configuration file", category: "config" },
  ...
  "/extra-usage": { description: "Configure extra usage to keep working when limits are hit", category: "config" },
  "/plugin": { description: "Plugin management", category: "config" },
  "/reload-plugins": { description: "Activate pending plugin changes in the current session", category: "config" },
  ...
  "/remote-env": { description: "Configure the default remote environment for teleport sessions", category: "config" },
  ...
  "/init-verifiers": { description: "Create verifier skill(s) for automated verification of code changes", category: "nav" },
  "/security-review": { description: "Complete a security review of the pending changes on the current branch", category: "nav" },
  "/batch": { description: "Research and plan a large-scale change, then execute it in parallel", category: "nav" },
  "/schedule": { description: "Create, update, list, or run scheduled remote agents", category: "nav" },
  "/simplify": { description: "Review changed code for reuse, quality, and efficiency", category: "nav" },
  "/loop": { description: "Run a prompt or slash command on a recurring interval", category: "nav" },
  "/claude-api": { description: "Build apps with the Claude API or Anthropic SDK", category: "nav" },
  // Debug / diagnostics
  "/doctor": { description: "Diagnose and verify your Claude Code installation and settings", category: "debug" },
  "/debug": { description: "Enable debug logging for this session and help diagnose issues", category: "debug" },
  ...
  "/cost": { description: "Show the total cost and duration of the current session", category: "info" },
  "/usage": { description: "Show plan usage limits", category: "info" },
  "/status": { description: "Show Claude Code status including version, model, and account", category: "info" },
  "/context": { description: "Visualize current context usage as a colored grid", category: "info" },
  "/stats": { description: "Show your Claude Code usage statistics and activity", category: "info" },
  ...
  "/upgrade": { description: "Upgrade to Max for higher rate limits and more Opus", category: "info" },
  "/insights": { description: "Generate a report analyzing your Claude Code sessions", category: "info" },
 ...
 */
export const FALLBACK_SLASH_COMMANDS: SlashCommand[] = Object.entries(KNOWN_COMMAND_INFO).map(
