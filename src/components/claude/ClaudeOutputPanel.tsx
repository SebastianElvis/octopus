            ...
            <div className="text-center">
              {historyLoading ? (
                <div className="flex flex-col items-center gap-2">
                  <span className="inline-block h-3 w-3 animate-pulse rounded-full bg-on-surface-faint" />
      ...
      {showScrollBtn && (
        <div className="absolute bottom-16 left-1/2 z-20 -translate-x-1/2">
          <button
            ...
            className="cursor-pointer rounded-full bg-surface-overlay px-3 py-1.5 text-xs font-medium text-on-surface shadow-lg hover:bg-active"
          >
            Scroll to bottom
          </button>
        </div>
